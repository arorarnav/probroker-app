...
export async function POST(req) {
  // Created here, inside the request, not at module load time -- otherwise
  // Vercel's build step (which loads every route to validate it) crashes
  // before environment variables even exist, taking down the whole deploy.
